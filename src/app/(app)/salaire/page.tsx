...
const initialEmployees: Employee[] = [
  { matricule: '21072', noms: 'John TSHIAMALA', departement: 'Ventes', salaire: 3000 },
  { matricule: 'E001', noms: 'Alice Bernard', departement: 'Marketing', salaire: 2800 },
  { matricule: 'E002', noms: 'Bob Leclerc', departement: 'Ingénierie', salaire: 3500 },
];

const initialHistory: SalaryChange[] = [
...
function SalaryChangeContent() {
  ...
  const [history, setHistory] = React.useState<SalaryChange[]>(initialHistory);
  ...
  React.useEffect(() => {
    // Pre-select the employee from history for demo purposes
    if (initialHistory.length > 0) {
      const firstHistoryItem = initialHistory[0];
  ...
  const handleApplyChange = () => {
    ...
    setHistory(prev => [newChange, ...prev.filter(h => h.nouvelleValeur !== newChange.nouvelleValeur)]); // Avoid duplicates for demo
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <Input id="noms" value={selectedEmployee?.noms || ''} className="bg-gray-100" readOnly />
            </div>
            <div className="space-y-2">
              <Label htmlFor="change-date">Date de l'application du changement</Label>
              <Popover>
            ...
            <div className="space-y-2">
              ...
              <Input id="current-salary" value={selectedEmployee ? new Intl.NumberFormat('fr-FR', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(selectedEmployee.salaire) : ''} className="bg-gray-100" readOnly />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="reason" placeholder="Motif du Changement" value={reason} onChange={e => setReason(e.target.value)} />
            </div>
             <div className="space-y-2">
              <Label htmlFor="new-department">Nouveau Département (si applicable)</Label>
              <Input id="new-department" placeholder={selectedEmployee?.departement || ''} value={newDepartment} onChange={e => setNewDepartment(e.target.value)} />
            </div>
          </div>
        ...
        <div className="flex items-center border-b">
            ...
            <Tabs defaultValue="salaire" className="w-full">
                <TabsList className="ml-4 bg-transparent p-0 border-b-0 rounded-none">
                    ...
                    <TabsTrigger value="fonction" disabled className="data-[state=active]:border-b-primary data-[state=active]:shadow-none rounded-none border-b-2 border-transparent">
                ...
                <TabsContent value="fonction">
                    <div className="p-6">Contenu de la page Fonction à venir.</div>
                </TabsContent>
